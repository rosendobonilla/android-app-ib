...
public abstract class CameraActivity extends Activity implements OnImageAvailableListener, Camera.
  ...
  public void onPreviewFrame(final byte[] bytes, final Camera camera) {
    ...
    postInferenceCallback = new Runnable() {
      ...
      //Enviar objeto Camara al procesador ClassifierActivity
      processImageRGBbytes(rgbBytes, camera);
  }
  ...
  public void onImageAvailable(final ImageReader reader) {
    ...
    //Comento metodo que no se utiliza por error en Camera camera
    //processImageRGBbytes(rgbBytes, came);
    Trace.endSection();
  ...
  //Agregar Camera camera al método abstracto para enviar el objeto camara y poder para el preview
  protected abstract void processImageRGBbytes(int[] rgbBytes, Camera camera) ;
